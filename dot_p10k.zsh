# Generated by Powerlevel10k configuration wizard on 2025-03-24 at 01:27 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_SUBSEGMENT_SEPARATOR='  '  # separate segments with two spaces
                                                                  # needed for JetBrains Mono NF
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="#b4befe" # lavender
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND="#b4befe" # lavender
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND="#b4befe" # lavender
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#cba6f7}'  # lavender foreground
      local   modified='%F{#f2cdcd}'  # flamingo foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR="#cba6f7" # mauve
